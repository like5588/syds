...
$(document).ready(function(){
	$("#logout").click(function(){
		$.ajax({
			url : "${pageContext.request.contextPath}/logout_dx.do",
			type : 'POST',
			data : "",
			dataType:"json",
			cache : false,
...
<div class="yg_menu_bg" id="title">
	<div class="yg_menu">
       ...
       <div class="yg_menu_login">
            <%if(userId == null){ %>
	       		<a href="http://www.hicdma.com/mh/views/pages/login.jsp?redirect=<%=base_url%>/teleCom_index.jsp">登录</a>&nbsp;&nbsp;|&nbsp;
	            <a href="http://www.hicdma.com/mh/register.html?redirect=<%=base_url%>/teleCom_index.jsp">注册</a>
            <%}else{ %>
