	...
	<div id="main" style="margin: 20px;">
		...
		<div style="border-bottom: 1px solid #eee; margin-bottom: 20px;margin-top: 20px;">
			<form class="form-inline" id="query_form" style="margin-bottom: 15px;">
				<input type="hidden" name="isSelect" id="isSelect" value="1">
			...
			<div align="right">
				<button type="button" id="daixuan" class="btn btn-primary" onclick="pass(2,1)"
					style="margin-right: 10px;margin-top: -7px;float: right;">提交入围</button>
				<button type="button" id="daixuan" class="btn btn-primary" onclick="pass(0,1)"
					style="margin-right: 10px;margin-top: -7px;float: right;">取消入选</button>
