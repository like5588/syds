...
<body>
      ...
      <textarea rows="3" cols="40" id="tt"></textarea>
      <textarea rows="3" cols="40" id="yy"></textarea>
</body>
  ...
  document.querySelector('#chooseImage').onclick = function () {
    wx.chooseImage({
      success: function (res) {
    	document.querySelector('#tt').value=res.localIds;
  ...
  document.querySelector('#uploadImage').onclick = function () {
    ...
    function upload() {
      wx.uploadImage({
        ...
        success: function (res) {
          document.querySelector('#yy').value += res.serverId+",";
          i++;
          alert('已上传：' + i + '/' + length);
          ...
          if (i < length) {
            upload();
        	    ...
        	    $.ajax({
        			url : "upload.do",
        			type : 'POST',
        			data : "serverIds="+images.serverId[0],
        			dataType:"html",
        			cache : false,
