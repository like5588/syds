...
<body>
    <div class="container">
      ...
      <form class="form-signin" role="form" id="form1" style="padding-top: 0px;" method="post">
		...
		<img id="img" src="randImageServlet" style="width: 43%; height: 44px;border-radius: 4px;cursor:pointer;" onclick="refresh(this);">
