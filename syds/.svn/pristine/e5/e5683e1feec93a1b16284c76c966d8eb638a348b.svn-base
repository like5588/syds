...
<div align="center"> 
 	<c:if test="${page.pageTotal>1}">
	      <ul class="pagination">
	    	...
	    	<li><span style="margin-left: 15px; border: 0px; padding-right: 5px;">跳转到：</span><input type="text" class="form-control"  style="width: 50px;" id="page_Num"><input type="button" class="btn btn-default" style="margin-left: 15px;" value="确定" onclick="toPage(${page.pageTotal})"></li>
	     </ul>
	</c:if>
</div>
<script>
function toPage(_total){
