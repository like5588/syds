...
<form id="photos_form">
<input type="hidden" id="_pageIndex" value="${page.pageIndex}">
							...
							<div class="panel panel-default image-panel">
							  <div class="panel-body image-body">
							  	<div style="width: 100%;position: relative;">
							  		<c:if test="${photoInfoDto.excellent eq 1}">
							  			<img src="../images/excellent.png" style="position:absolute;left: 75%;width: 25%;">
							  		</c:if>
	        ...
	        <div class="swiper-wrapper" onclick="hideMask();">
	        	<c:if test="${photoInfoDtoList ne null}">
					<c:if test="${listSize>0}">
					    ...
					    <div class="swiper-slide listimg_big">
